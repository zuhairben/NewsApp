...
function App() {
    return (
      <div>
        ...
        <Navbar/>
         <Routes>  
          {/* <Route exact path="/" element={<News  key={'World'} pageSize = {9} country = {'pk'} category={'world'}/>} /> */}
          ...
          <Route exact path="/technology" element={<News  key={'technology'} pageSize = {9} country = {'in'} category={'technology'}/>} />          </Routes> 
        </Router>
      </div>
    )
  }
